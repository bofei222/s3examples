...
public class Main2 {
    public static void main(String[] args) {
        ...
        int p2 = 5 * 1024 * 1024; //分段大小在 5MB - 5GB 之间，只有最后一个分段才允许小于 5MB，不可避免的
        int p3 = 9 * 1024 * 1024; //分段大小在 5MB - 5GB 之间，只有最后一个分段才允许小于 5MB，不可避免的
        ...
        boolean open = toS3.open("bofei的一个5M+9M文件", "w");
